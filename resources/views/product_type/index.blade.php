...
<div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
        <div class="modal-header">
            <h2 class="modal-title fs-5" id="update_modalLabel">Actualización Tipo de Productos</h2>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
            <form id="form_product_type_update"  action="{{ route('product_type_edit.update', $product_type) }}"   method="POST">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            {{-- <input type="hidden" id="id_lead" name="id_lead" value=""> --}}
                            <label for="tipo_producto" class="label_style">Actualizar el tipo de producto:</label>
                            <input type="text" name="product_type_id" value="{{$product_type->id}}">
